...
```{r}
BUSINESS <- 'nursing or convalescent'
Business_Path <- './nursing or convalescent'
```
...
```{r}
for (i in Table10$functionInput[151:206]){
  writeYellowPageBusinessTypes(i)
...
```{r}
for (i in Table10$functionInput[207:244]){
  writeYellowPageBusinessTypes(i)
...
```{r}
for (i in Table10$functionInput[245:296]){
  writeYellowPageBusinessTypes(i)
...
```{r}
for (i in Table10$functionInput[297:300]){
  writeYellowPageBusinessTypes(i)
