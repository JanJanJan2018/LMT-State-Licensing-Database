...
```{r}
for (i in Table10$functionInput[1:25]){
  writeYellowPageBusinessTypes(i)
      somethingToDo <-  read.csv(paste(Business_Path,'/',BUSINESS,'.csv',sep=''),
                                 sep=",", header=FALSE, 
                                 na.strings=c('',' ','NA'))
      header <- read.csv(paste(Business_Path,'/tableBusinessesHeader_',BUSINESS,'.csv',
                         sep=''), sep=',')
      names <- header$x
      All <- somethingToDo[!duplicated(somethingToDo),]
      colnames(All) <- names
      colnames(All)[3] <- paste(BUSINESS,colnames(All)[3],sep='_')
      write.csv(All,paste(BUSINESS,'All.csv',sep=''),row.names=FALSE)
}
```


```{r}
for (i in Table10$functionInput[26:50]){
  writeYellowPageBusinessTypes(i)
      somethingToDo <-  read.csv(paste(Business_Path,'/',BUSINESS,'.csv',sep=''),
                                 sep=",", header=FALSE, 
                                 na.strings=c('',' ','NA'))
...
```{r}
for (i in Table10$functionInput[76:100]){
  writeYellowPageBusinessTypes(i)
      somethingToDo <-  read.csv(paste(Business_Path,'/',BUSINESS,'.csv',sep=''),
                                 sep=",", header=FALSE, 
                                 na.strings=c('',' ','NA'))
...
```{r}
for (i in Table10$functionInput[101:125]){
  writeYellowPageBusinessTypes(i)
      somethingToDo <-  read.csv(paste(Business_Path,'/',BUSINESS,'.csv',sep=''),
                                 sep=",", header=FALSE, 
                                 na.strings=c('',' ','NA'))
...
```{r}
for (i in Table10$functionInput[126:140]){
  writeYellowPageBusinessTypes(i)
      somethingToDo <-  read.csv(paste(Business_Path,'/',BUSINESS,'.csv',sep=''),
                                 sep=",", header=FALSE, 
                                 na.strings=c('',' ','NA'))
...
```{r}
for (i in Table10$functionInput[140:150]){
  writeYellowPageBusinessTypes(i)
      somethingToDo <-  read.csv(paste(Business_Path,'/',BUSINESS,'.csv',sep=''),
                                 sep=",", header=FALSE, 
                                 na.strings=c('',' ','NA'))
...
```{r}
for (i in Table10$functionInput[151:175]){
  writeYellowPageBusinessTypes(i)
      somethingToDo <-  read.csv(paste(Business_Path,'/',BUSINESS,'.csv',sep=''),
                                 sep=",", header=FALSE, 
                                 na.strings=c('',' ','NA'))
...
```{r}
for (i in Table10$functionInput[176:200]){
  writeYellowPageBusinessTypes(i)
      somethingToDo <-  read.csv(paste(Business_Path,'/',BUSINESS,'.csv',sep=''),
                                 sep=",", header=FALSE, 
                                 na.strings=c('',' ','NA'))
      ...
      colnames(All) <- names
      colnames(All)[3] <- paste(BUSINESS,colnames(All)[3],sep='_')
      write.csv(All,paste(Business_Path,'All.csv',sep=''),row.names=FALSE)
}
```


```{r}
for (i in Table10$functionInput[201:225]){
  writeYellowPageBusinessTypes(i)
      somethingToDo <-  read.csv(paste(Business_Path,'/',BUSINESS,'.csv',sep=''),
                                 sep=",", header=FALSE, 
                                 na.strings=c('',' ','NA'))
...
```{r}
for (i in Table10$functionInput[226:237]){
  writeYellowPageBusinessTypes(i)
      somethingToDo <-  read.csv(paste(Business_Path,'/',BUSINESS,'.csv',sep=''),
                                 sep=",", header=FALSE, 
                                 na.strings=c('',' ','NA'))
...
```{r}
for (i in Table10$functionInput[238:248]){
  writeYellowPageBusinessTypes(i)
      somethingToDo <-  read.csv(paste(Business_Path,'/',BUSINESS,'.csv',sep=''),
                                 sep=",", header=FALSE, 
                                 na.strings=c('',' ','NA'))
...
```{r}
for (i in Table10$functionInput[249:250]){
  writeYellowPageBusinessTypes(i)
      somethingToDo <-  read.csv(paste(Business_Path,'/',BUSINESS,'.csv',sep=''),
                                 sep=",", header=FALSE, 
                                 na.strings=c('',' ','NA'))
...
```{r}
for (i in Table10$functionInput[251:275]){
  writeYellowPageBusinessTypes(i)
      somethingToDo <-  read.csv(paste(Business_Path,'/',BUSINESS,'.csv',sep=''),
                                 sep=",", header=FALSE, 
                                 na.strings=c('',' ','NA'))
...
```{r}
for (i in Table10$functionInput[479:486]){
  writeYellowPageBusinessTypes(i)
  somethingToDo <-  read.csv(paste(Business_Path,'/',BUSINESS,'.csv',sep=''),
                                 sep=",", header=FALSE, 
                                 na.strings=c('',' ','NA'))
...
```{r}
for (i in Table10$functionInput[487:489]){
  writeYellowPageBusinessTypes(i)
  somethingToDo <-  read.csv(paste(Business_Path,'/',BUSINESS,'.csv',sep=''),
                                 sep=",", header=FALSE, 
                                 na.strings=c('',' ','NA'))
...
```{r}
for (i in Table10$functionInput[490:500]){
  writeYellowPageBusinessTypes(i)
  somethingToDo <-  read.csv(paste(Business_Path,'/',BUSINESS,'.csv',sep=''),
                                 sep=",", header=FALSE, 
                                 na.strings=c('',' ','NA'))
...
```{r}
All <- read.csv(paste(BUSINESS,'All.csv',sep=''), 
...
businessCounts <- All %>% group_by(state) %>% count(state)
